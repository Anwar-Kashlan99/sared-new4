...
import { Bookmark, Close, Edit, MoreVert, Share } from "@mui/icons-material";
...
const BlogDetail = () => {
  ...
  const [selectedImage, setSelectedImage] = useState(
    `${process.env.REACT_APP_SERVER_DOMAIN}/${blog?.img}` || blogeCover
  );
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Avatar
                ...
                src={`${process.env.REACT_APP_SERVER_DOMAIN}/${blog?.profile}`}
              />
              <Box
                sx={{
                  display: "flex",
          ...
          >
            ...
            >
              <Typography>{formatDateWithYear(blog?.careatedAt)}</Typography>
            </Box>
          </Box>
